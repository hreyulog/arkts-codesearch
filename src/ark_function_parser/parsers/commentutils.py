def match_license_comment(comment: str) -> bool:
    """Check if comment contains license markers."""
    return all(word in comment.lower() for word in ['copyright', 'license'])

def strip_c_style_comment_delimiters(comment: str) -> str:
    """Clean comments from them markers."""
